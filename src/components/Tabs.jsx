...
export default function Tabs() {
  ...
  // This is the correct, functional version of the AuthButtons component
  const AuthButtons = () => {
    if (user) {
      return (
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-2 px-3 py-2 rounded-md font-semibold bg-red-600 hover:bg-red-700 text-white transition-colors text-sm"
          >
      ...
      return (
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/register"
            className="flex items-center gap-2 px-3 py-2 rounded-md font-semibold bg-cyan-600 hover:bg-cyan-700 text-white transition-colors text-sm"
          >
