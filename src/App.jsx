...
const AppLayout = ({ children }) => {
  ...
  // Don't show the main layout on the landing page
  if (location.pathname === '/') {
    return <>{children}</>;
  }

  // Show the main layout for all other pages
  return (
    <div className="relative min-h-screen bg-primary-bg text-text-primary flex flex-col overflow-x-hidden">
      <div 
