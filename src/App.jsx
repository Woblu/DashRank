...
// [FIX] Removed redundant LanguageProvider, it's in main.jsx now
...
export default function App() {
  return (
    ...
    <div className="relative min-h-screen bg-primary-bg text-text-primary flex flex-col overflow-x-hidden"> {/* [FIX] Theme classes applied */}
      <div 
      ...
      <main className="flex-grow p-4 w-full max-w-7xl mx-auto z-20">
        <Routes>
          ...
          <Route path="/admin" element={<AdminRoute><AdminDashboard /></AdminRoute>}>
            <Route index element={<div className="text-text-primary text-center"><h1>Welcome to the Admin Dashboard!</h1><p>Select a section to manage.</p></div>} /> {/* [FIX] Theme class applied */}
